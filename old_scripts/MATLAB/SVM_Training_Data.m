...
for vli=vli_start:size(manual_final_insect.somewhat_likely,2)
     ...
     clearvars -except start_file date filename fols events manual_final_insect vli int sl mode_run_time data fn
...
save(fullfile(filename,'Training_Data','sl.analysis_data.mat'));
