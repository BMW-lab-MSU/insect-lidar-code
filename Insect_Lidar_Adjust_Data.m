...
% runs=dir(fullfile(date_dir,'\AMK_RANCH_CS_Blue*'));
runs=dir(fullfile(date_dir,'Hyalite*'));
...
for rn = rn_vec
    ...
    parfor vn = 1:size(vecs,1)
        ...
        %full_data = old_data_fix(rd); %call this for 2016 data
        ...
        %line up for data that has to be fixed
