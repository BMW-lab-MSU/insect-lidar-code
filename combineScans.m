...
DATA_FILENAME = "adjusted_data_junecal.mat";
LABELS_FILENAME = "labels.mat";

basefilepath = "~/research/afrl/insect-lidar/data/msu-bee-hives";

days = ["2022-06-23", "2022-06-23"];
...
for i = 1:numel(days)
    for j = 1:numel(scanIds{i})
        ...
        scans(scanNum).Data = cellfun(@(c) single(c), ...
            {adjusted_data_junecal.normalized_data}', ...
            'UniformOutput', false);
...
save(basefilepath + filesep + "combined-data-2022-06-23-2022-06-24", 'scans', '-v7.3');
toc
