...
tilt_vec=[];for n=0:.5:15;tilt_vec=[tilt_vec repmat(n,[1,8])];end
pan_vec=[];vv=0:.5:6;for n=1:size(tilt_vec,2)/8/2; pan_vec=[pan_vec vv flip(vv)];end
% date directory
...
runs=dir([date_dir,'\AMK_RANCH_CS_RedLED*']);
