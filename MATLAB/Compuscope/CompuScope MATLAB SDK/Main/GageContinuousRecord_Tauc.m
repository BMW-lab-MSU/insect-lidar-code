...
clearvars -except panloc tiltloc QPT130 jog output tl systems ret handle...
    ...
    start_pan end_pan delta_pan delta_tilt pause_time oc tilt_final;
...
%         filename = sprintf(format_string, 'MulRec', transfer.Channel, i);
        full_data{((2*n)-1),i+(fdm*acqInfo.SegmentCount)}=data';
        full_data{(2*n),i+(fdm*acqInfo.SegmentCount)}=full_info';
