...
clearvars -except panloc tiltloc QPT130 jog output tl systems ret handle sysinfo s;
...
format_string = sprintf([datestamp, '%%s_CH%%0%dd-%%0%dd.dat'], MaxChannelNumber, MaxSegmentNumber);
