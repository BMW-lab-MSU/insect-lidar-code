...
% Channel     : 0 (PS5000A_CHANNEL_A) 1 (Channel_B)
% Threshold   : 1000 (mV)
% Direction   : 2 (Rising) 1 (Falling)
% Delay       : 0
% Auto trigger: 4000 (wait for 1 second)

[status] = invoke(ps5000aDeviceObj, 'setSimpleTrigger', 1, 40000, 1, 0, 1000);
disp('triggered')
%% GET TIMEBASE
...
[status, timeIntervalNanoSeconds, maxSamples] = invoke(ps5000aDeviceObj, 'ps5000aGetTimebase', 4000000, 0);
